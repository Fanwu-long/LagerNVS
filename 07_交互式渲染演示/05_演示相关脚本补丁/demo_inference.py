...
def main():
    ...
    import time; _t0 = time.time(); print(f"Rendering {args.video_length} frames...")
    with torch.no_grad():
    ...
    print(f"Saved to {args.output}"); _dt = time.time() - _t0; print("RENDER_METRIC %.1fs total, %.2f FPS" % (_dt, args.video_length / _dt))
